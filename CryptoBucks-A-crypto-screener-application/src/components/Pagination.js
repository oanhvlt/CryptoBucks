      ...
      <div className="flex items-center">
        ...
        <ul className="flex items-center justify-end text-sm">
          ...
          {page + 1 === TotalNumber || page === TotalNumber ? (
            <li>
              {" "}
              <button className="ouline-0 hover:text-cyan  rounded-full w-8 h-8 flex 
          ...
          <li>
            <button disabled className="ouline-0 rounded-full w-8 h-8 
            flex items-center justify-center bg-cyan text-gray-300 mx-1.5">
              {page}
            </button>
          </li>
          ...
          {page + 1 !== TotalNumber && page !== TotalNumber ? (
            <li>
              <button className="ouline-0 hover:text-cyan  rounded-full w-8 h-8 
                flex items-center justify-center bg-gray-200 mx-1.5"
                onClick={next}>
                {page + 1}
              </button>
            </li>
